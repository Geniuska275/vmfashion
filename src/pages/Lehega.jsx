...
export default function LehengaCholiCollection() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-2xl font-bold text-gray-900 mb-6">Lehenga Choli</h1>
        </div>

        {/* Welcome Description */}
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-gray-700 text-md leading-relaxed">
            Welcome! You are in a safe place. We're the best online store where you can easily order that heavenly
            well-fitted lehenga choli for a special wedding, ethnic event, or festivity. If you are a petite, plus size,
            minimalist lover, or last-minute shopper, you'll get your type of Indian lehenga at Andaaz Fashion.
          </p>
        </div>
      </div>
      <ProductList/>

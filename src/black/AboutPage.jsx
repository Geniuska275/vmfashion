...
liability shall be limited to the maximum extent permitted by law.
            ...
            <div>
              ...
              <div className="flex about gap-3 justfify-evenly ">
                ...
                <p className=" leading-8 text-xl md:text-2xl  md:leading-[50px] font-[Poppins] mt-3"> We are VM Fashion
(formally Jabeens)
established in ...........
...
elegant ethnic wear for all occasions.</p>
                ...
                <p className="leading-8  text-xl md:text-2xl md:leading-[50px] font-[Poppins]">We take pride in our
...
{/*  */}
                ...
                <p className="leading-8 md:leading-10 text-xl md:text-2xl font-[Poppins]">Our aim is not only to
